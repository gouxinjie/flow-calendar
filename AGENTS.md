...
本文档是 `lime-calendar` 项目的执行约束，面向后续参与该仓库的 Agent、开发者与协作者。

目标只有一个：围绕 PRD 落地 **青柠日历（Lime Calendar）Web 移动端 H5 MVP**，避免需求发散、技术跑偏和实现口径不一致。
...
- 所有注释必须使用**中文**
- 用户可见文案默认使用中文，可保留品牌名 `Lime Calendar`

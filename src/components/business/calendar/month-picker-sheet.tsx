    ...
    <BottomSheet
      ...
      footer={
        <button
          ...
          className="flex h-[48px] w-full items-center justify-center rounded-[14px] bg-[#169968] text-[14px] font-semibold text-white active:opacity-80"
        >
          回到本月
        </button>
      }
            ...
            {yearOptions.map((y) => (
              <button
                ...
                className={cn(
                  ...
                  year === y ? "bg-[#169968] text-white" : "bg-[#F3F7F6] text-[#6B7A7A]",
                )}
              >
                {y}
              </button>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    !isFuture && isCurrent && "bg-[#169968] text-white",

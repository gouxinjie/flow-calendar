    ...
    <div className="flex min-h-[100dvh] flex-col items-center justify-center bg-[#F3FAF7] px-6">
      ...
      <div className="animate-page-enter w-full max-w-[380px]">
        <div className="mb-8 text-center">
          <h1 className="flex items-center justify-center gap-2 text-[28px] font-semibold tracking-[-0.03em] text-[#5EBF3F]">
            <img src="/qingning.svg" alt="" className="h-[32px] w-[32px]" />
            青柠日历
          </h1>
